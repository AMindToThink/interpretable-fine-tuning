...
# Apply preprocessing
train_dataset = train_split.map(extract_moss_responses, remove_columns=train_split.column_names)
val_dataset = val_split.map(extract_moss_responses, remove_columns=val_split.column_names)
