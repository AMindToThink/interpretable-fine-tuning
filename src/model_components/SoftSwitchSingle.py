...
class SoftSwitchSingle(nn.Module):
    def __init__(self, a=0.0, b=1.0, k=1.0, trainable=True):
        ...
        """
        super(SoftSwitchSingleSingle, self).__init__()
...
if __name__ == "__main__":
    ...
    module = SoftSwitchSingleSingle(a=0.0, b=2.0, k=3.0)
    # Compute the output
    y = module(x)
    ...
    plt.xlabel('x')
    plt.ylabel('y')
    plt.title('SoftSwitchSingleSingle Function')
